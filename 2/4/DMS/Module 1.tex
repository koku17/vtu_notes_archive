...
\begin{document}
	...
	\subsection{Duality}
	\begin{itemize}[label=]
		\item Suppose $u$ is a compound proposition that containes the connectives AND $(\land)$ or
	...
	\subsection{Argument}
	\begin{itemize}[label=]
		\item Consider a set of propositons $p1,p2,p3,\cdots,pn$ and the proposition $q$ then a compound
